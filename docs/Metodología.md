...
Para visualizar la exploración de datos se puede consultar el [notebook](/docs/Análisis_descriptivo_Covid.html)
Para visualizar la limpieza de datos se puede consultar el [.py](/utilities/utilities.py)
Para visualizar el modelo SIRD se puede consultar el [.py](/SIR_model.py)
Para visualizar la predicción del SIRD se puede consultar el [.py](/SIR_predict.py)
Para visualizar los errores e intervalos de confianza del SIRD se puede consultar el [.py](/SIR_error.py)